...
\input{../laulut/sahtilaulu}           %
\input{../laulut/se-kolmas-vesilaulu}  %
\input{../laulut/yli-koskien}          %
\input{../laulut/viinin-kaipuu}        %
\input{../laulut/kaks-kisälliä}        %
\input{../laulut/helan-går}            %
\input{../laulut/hei-vahtimestari}     %
\input{../laulut/takki-pois}           %

\clearpage
\input{../laulut/international/my-favourite-drinks} %
\input{../laulut/vesikansan-marssi}    %
\vspace{-0.3cm}
\input{../laulut/as-phuksin-laulu}     %
\input{../laulut/nostakaamme-malja}
\input{../laulut/mellan-sup}           %
\input{../laulut/stimulaulu}           %
\input{../laulut/pikku-paviljonki}     %
\vspace{0.5cm}
\input{../laulut/nisti-ja-nööri}       %
\newpage
\input{../laulut/jallutähden-alla}     %
