...
class GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, booklet_format, bookletizer):
        ...
        self.init_buttons()
        #self.init_sliders()
        self.add_song_title("Askiin")
        print(self.selected_songs.getSongTitles())
    ...
    def init_buttons(self):
        ...
        self.empty_btn = QtWidgets.QPushButton("Empty")
    ...
    def init_window(self):
        ...
        self.horizontal.addLayout(left_vertical, 35)
    ...
    def init_pdf_viewer(self):
        ...
        self.horizontal.addWidget(self.pdf_viewer, 65)
        self.pdf_viewer.show()

    def update_pdf_viewer(self, page):
        self.pdf_viewer.changePixmap("GUI/a4_half/{}".format(page))

    def add_song_title(self, title):
        if title not in self.selected_songs.getSongTitles():
            self.selected_songs.addItem(QtWidgets.QListWidgetItem(title))
            return True
        return False

    def generateNewView(self):
        self.bookletizer.generateTexFile(self.selected_songs.getSongTitles())
        images = convert_from_path("a4_half.pdf")
